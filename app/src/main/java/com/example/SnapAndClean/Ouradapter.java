...
public class Ouradapter extends RecyclerView.Adapter<Ouradapter.ViewHolder>{
    ...
    public Ouradapter(Context context, List<Productmodel> productmodelList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new Ouradapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.myuploadwastage,parent,false));
